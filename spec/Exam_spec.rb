	...
	describe 'Exam' do
	  ...
	  context "Class Exam test" do
	    ...
	    it 'checking class Exam atributes' do
	    	expect(Exam).to respond_to(:correct)
	    	expect(Exam).to respond_to(:incorrect)
	    	expect(Exam).to respond_to(:calification)
	    end
	    ...
	    it 'checking class Exam start method' do
	    	expect(Exam).to respond_to(:start)
	    end
	  end
	end
end